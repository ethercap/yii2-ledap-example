            ...
            <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="card-body">
                  <div class="chart-area"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                    <canvas id="myAreaChart" width="1224" height="640" class="chartjs-render-monitor" style="display: block; height: 320px; width: 612px;"></canvas>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="chart-pie pt-4 pb-2"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                    <canvas id="myPieChart" width="546" height="490" class="chartjs-render-monitor" style="display: block; height: 245px; width: 273px;"></canvas>
                  </div>
              ...
              <b-row>
                <b-col cols="6" class="mb-4" v-for="item in colors" :key="item.title">
                    <b-card class="shadow" :class="[item.bg, item.textblack ? 'text-black' : 'text-white']">
                        {{item.title}}
                        <div class="text-white-50 small" :class="[item.textblack ? 'text-black-50' : 'text-white-50']">{{item.value}}</div>
                    </b-card>
                </b-col>
              </b-row>      
